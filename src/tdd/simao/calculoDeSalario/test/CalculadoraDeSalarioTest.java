...
public class CalculadoraDeSalarioTest {
	...
	public void deveCalcularSalarioParaDesenvolvedoresComSalarioAbaixoDoLimite(){
		...
		Assert.assertEquals(funcionario.getSalario() * 0.9, salario, 0.00001);
	}
	...
	public void deveCalcularSalarioParaDesenvolvedoresComSalarioAcimaDoLimite(){
		...
		Assert.assertEquals(funcionario.getSalario() * 0.8, salario, 0.00001);
	}
	...
	public void deveCalcularSalarioParaDBAsComSalarioAbaixoDoLimite(){
		...
		double salario = calculadoraDeSalario.calcular(funcionario);
		Assert.assertEquals(funcionario.getSalario() * 0.85, salario, 0.00001);
	}
